...
import lesson4.lecture.finalinherit.Super;
...
public class Main {
	...
	private static <T extends U , U > boolean contains3(List<T> list, U e, BiPredicate<? super T,U> pred2) {
